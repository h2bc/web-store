...
- A cart id the backend answers 404 or already completed for reads as the empty cart, without an error, and the next add to cart creates a new cart and replaces the cookie.
