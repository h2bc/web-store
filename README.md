...
`pnpm lint` and `pnpm checkFormat` run ESLint and Prettier over both apps; the pre-commit hook runs both. CI also runs the typechecks, the API tests and the e2e suite.
