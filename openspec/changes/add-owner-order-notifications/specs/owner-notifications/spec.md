...
- **WHEN** an order without an email address is placed and Telegram is configured
- **THEN** the Telegram notification is still recorded
...
- **WHEN** `TELEGRAM_CHAT_ID` is not set and an order is placed
